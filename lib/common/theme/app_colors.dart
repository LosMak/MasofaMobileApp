...
abstract class AppColors {
  ...
  static const MaterialColor slate = MaterialColor(500, <int, Color>{
    50: Color(0xFFF8FAFC),
  ...
  static const MaterialColor gray = MaterialColor(500, <int, Color>{
    50: Color(0xFFF9FAFB),
  ...
  static const MaterialColor zinc = MaterialColor(500, <int, Color>{
    50: Color(0xFFFAFAFA),
  ...
  static const MaterialColor neutral = MaterialColor(500, <int, Color>{
    50: Color(0xFFFAFAFA),
  ...
  static const MaterialColor stone = MaterialColor(500, <int, Color>{
    50: Color(0xFFFAFAF9),
  ...
  static const MaterialColor red = MaterialColor(500, <int, Color>{
    50: Color(0xFFFEF2F2),
  ...
  static const MaterialColor orange = MaterialColor(500, <int, Color>{
    50: Color(0xFFFFF7ED),
  ...
  static const MaterialColor amber = MaterialColor(500, <int, Color>{
    50: Color(0xFFFFFBEB),
  ...
  static const MaterialColor yellow = MaterialColor(500, <int, Color>{
    50: Color(0xFFFEFCE8),
  ...
  static const MaterialColor lime = MaterialColor(500, <int, Color>{
    50: Color(0xFFF7FEE7),
  ...
  static const MaterialColor green = MaterialColor(500, <int, Color>{
    50: Color(0xFFF0FDF4),
  ...
  static const MaterialColor emerald = MaterialColor(500, <int, Color>{
    50: Color(0xFFECFDF5),
  ...
  static const MaterialColor teal = MaterialColor(500, <int, Color>{
    50: Color(0xFFF0FDFA),
  ...
  static const MaterialColor cyan = MaterialColor(500, <int, Color>{
    50: Color(0xFFECFEFF),
  ...
  static const MaterialColor sky = MaterialColor(500, <int, Color>{
    50: Color(0xFFF0F9FF),
  ...
  static const MaterialColor blue = MaterialColor(500, <int, Color>{
    50: Color(0xFFEFF6FF),
  ...
  static const MaterialColor indigo = MaterialColor(500, <int, Color>{
    50: Color(0xFFEEF2FF),
  ...
  static const MaterialColor violet = MaterialColor(500, <int, Color>{
    50: Color(0xFFF5F3FF),
  ...
  static const MaterialColor purple = MaterialColor(500, <int, Color>{
    50: Color(0xFFFAF5FF),
  ...
  static const MaterialColor fuchsia = MaterialColor(500, <int, Color>{
    50: Color(0xFFFDF4FF),
  ...
  static const MaterialColor pink = MaterialColor(500, <int, Color>{
    50: Color(0xFFFDF2F8),
  ...
  static const MaterialColor rose = MaterialColor(500, <int, Color>{
    50: Color(0xFFFFF1F2),
...
class MaterialColor extends ColorSwatch<int> {
  ...
  Color get shade0 => this[50]!;

  Color get shade1 => this[100]!;

  Color get shade2 => this[200]!;

  Color get shade3 => this[300]!;

  Color get shade4 => this[400]!;

  Color get shade5 => this[500]!;

  Color get shade6 => this[600]!;

  Color get shade7 => this[700]!;

  Color get shade8 => this[800]!;

  Color get shade9 => this[900]!;

  Color get shade10 => this[950]!;
}
